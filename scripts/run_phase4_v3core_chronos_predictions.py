#!/usr/bin/env python3
"""Run the credential-free prospective Chronos-2-small V3-Core worker."""
...
from advisorai.phase4.v3core_chronos import run
...
def main() -> int:
    ...
    try:
        ...
        raise SystemExit(f"forward Chronos prediction run refused ({type(exc).__name__})") from exc
