...
class ForwardPredictionRecord(BaseModel):
    ...
    The original baseline fields remain backward-compatible. Candidate workers
    may bind richer runtime/provenance identity without creating a second
    prediction truth format.
    """
