...
def default_candidates() -> tuple[ComponentCandidate, ...]:
    ...
    return (
        ...
        ComponentCandidate(
            ...
            required_for_core=True,
            notes="Primary lightweight forecast candidate; selection still requires measured evidence.",
        ),
        ComponentCandidate(
            name="ttm-r2",
            kind=ComponentKind.FORECAST_MODEL,
            import_name="transformers",
            privacy_boundary="local_model_worker",
            notes="Previous-generation control for the TTM-R3 comparison.",
        ),
        ComponentCandidate(
            name="lightgbm",
            kind=ComponentKind.FORECAST_MODEL,
        ...
        ComponentCandidate(
            ...
            privacy_boundary="local_cpu_model_worker",
            required_for_core=True,
            notes="Primary general financial-sentiment candidate; not preselected as winner.",
        ),
        ComponentCandidate(
            name="finbert-minilm",
            kind=ComponentKind.FINANCE_NLP,
            import_name="transformers",
            privacy_boundary="local_cpu_model_worker",
            notes="Fast-path sentiment candidate.",
        ),
        ComponentCandidate(
