...
| 3 current evidence addendum | Binance Spot Testnet depth snapshot/update reducer and raw replay boundary | [`tests/phase3/test_binance_depth_qualification.py`](../../tests/phase3/test_binance_depth_qualification.py), [`scripts/qualify_phase3_binance_spot_testnet_depth.py`](../../scripts/qualify_phase3_binance_spot_testnet_depth.py) | Real root `artifacts/phase3/binance-spot-testnet-depth/20260810T173135.489992Z/phase3-binance-spot-testnet-depth.json` has SHA-256 `b794c7fd2c014c89928c7bf2ad4b73fde253a615818dddd27a4da53a025c76c0`; four BTC/ETH snapshots and 289 updates replay-equivalent, all four fresh connections completed, and provider event timestamps were ahead of local receipt. Injected fault drills passed; clock-synchronized freshness, recovery, longer operation, source disagreement, and Phase-3 admission remain pending |
...
The latest local run on 2026-08-10 passed all 566 tests in one process with every
