...
|---|---|---|---|
| 0 | Typed gateway/archive/event ports; semantically normalized trading-authority denylist; direct, LiteLLM, and OmniRoute adapters; malformed tool-call rejection; candidate inventory including FinBERT and the optional hashing embedder; reproducible probe/stability records; durable Phase-0 gate records; durable redacted gateway-call records | [`tests/phase0`](../../tests/phase0), [`tests/contracts`](../../tests/contracts) | Pinned provider/runtime/model bake-offs and 24-hour resource/privacy/failure measurements |
...
| 4 | Mandatory naive/drift/seasonal/linear/LightGBM boundaries; installed CPU LightGBM/Transformers extras with typed checkpoint-bound runner paths; ModernFinBERT/MiniLM/DeBERTa sentiment roster; TTM-R3 with TTM-R2 control plus TSPulse/Chronos/Kronos/TabPFN-TS quarantine adapters; rolling calibration/abstention; utility/cost evaluation; one-family GPU lease; model inventory promotion evidence | [`tests/models`](../../tests/models) | Named-model checkpoint/resource/net-utility bake-offs and selected GPU-family decision |
