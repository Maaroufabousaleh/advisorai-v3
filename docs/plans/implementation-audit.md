...
The latest local run on 2026-08-10 passed all 521 tests in one process with every
...
format checking passes with all 244 Python files formatted. The Phase-1 local
