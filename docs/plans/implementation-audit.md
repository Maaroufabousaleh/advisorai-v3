...
| 4 | Mandatory naive/drift/seasonal/linear/LightGBM boundaries; installed CPU LightGBM/Transformers extras with typed checkpoint-bound runner paths; FinBERT-family typed news challenger; TTM-R2/TSPulse/Chronos/Kronos/TabPFN-TS quarantine adapters; rolling calibration/abstention; utility/cost evaluation; one-family GPU lease; model inventory promotion evidence | [`tests/models`](../../tests/models) | Named-model checkpoint/resource/net-utility bake-offs and selected GPU-family decision |
